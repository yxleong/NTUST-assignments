...
void display ( void )   // Create The Display Function
{
	...
	glVertex2f(0.0f, 0.2f);	// Mid-Bottom
	glColor3f(0.0f, 1.0f, 0.0f);	// Green
	glVertex2f(-0.4f, 0.5f);	// Mid-Left
	glColor3f(0.0f, 0.0f, 1.0f);	// Blue
	glVertex2f(0.4f, 0.5f);	// Mid-Right

	glColor3f(1.0f, 0.0f, 0.0f);	// Red
	glVertex2f(0.0f, 0.8f);	// Top-Top
	glColor3f(0.0f, 1.0f, 0.0f);	// Green
	...
	glColor3f(0.0f, 1.0f, 0.0f);	// Green
	glVertex2f(-0.15f, 0.3f);	// Left-Top
	//glColor3f(1.0f, 0.0f, 0.0f);	// Red
	glColor3f(0.0f, 0.0f, 1.0f);	// Blue
	glVertex2f(-0.25f, 0.0f);	// Left-Left
	glColor3f(1.0f, 0.0f, 0.0f);	// Red
	glVertex2f(0.0f, 0.2f);	// Left-Right

	//glColor3f(1.0f, 0.0f, 0.0f);	// Red
	glColor3f(0.0f, 0.0f, 1.0f);	// Blue
	glVertex2f(0.15f, 0.3f);	// Right-Top
	glColor3f(1.0f, 0.0f, 0.0f);	// Red
	glVertex2f(0.0f, 0.2f);	// Right-Left
	glColor3f(0.0f, 1.0f, 0.0f);	// Green
	//glColor3f(0.0f, 0.0f, 1.0f);	// Blue
	glVertex2f(0.25f, 0.0f);	// Right-Right
