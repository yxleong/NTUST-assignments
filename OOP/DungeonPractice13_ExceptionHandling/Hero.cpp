...
/*****************************************************************//**
 * Intent: To set the health point of Hero.
 * Pre: The variable hp must have a value and hp > 0.
 * Post: The function sets the health point of Hero.
 * \param hp
 *********************************************************************/
...
/*****************************************************************//**
 * Intent: To get the health point of Hero.
 * Pre: The variable sHp must be well-defined.
 * Post: The function returns the health point of Hero.
 * \return
 *********************************************************************/
